import { Button, CircularBadge } from '../ui/index.js';

export default function Hero() {
  return (
    <section
      id="inicio"
      className="min-h-screen bg-parchment-100 relative overflow-hidden pt-28 pb-20 px-6 text-center flex flex-col items-center justify-center"
    >
      <CircularBadge
        topText="Feliz Aniversário"
        bottomText="Sofia Marques"
        size={90}
      ...
      >
        ...
        <span className="block">de Sofia.</span>
      </h1>
      ...
      <p className="font-body italic text-body-lg text-sepia-700 max-w-xs leading-relaxed">
        Uma data que o mundo não merecia tanto.
      </p>

      <Button variant="ghost" href="/mensagens" className="mt-10">
        Ver as Mensagens
      </Button>
    </section>
  );
